					...
					<div class="wrapper">';
						if ( !empty( $headline ) || !empty( $sub_headline ) ) {
							$featured_content .='<div class="featured-heading-wrap">';
								if ( !empty( $headline ) ) {
									$featured_content .='<h2 id="featured-heading" class="entry-title">' . wp_kses_post( $headline ) . '</h2>';
								}
...
function fabulous_fluid_demo_content() {
	...
	$output = '
		<article id="featured-post-1" class="post hentry post-demo">
			<figure class="featured-content-image">
				<a title="' . esc_html__( 'Central Park', 'fabulous-fluid' ) .'" href="#">
					<img alt="' . esc_html__( 'Central Park', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-1.jpg" />
				</a>
			</figure>
		...
		<article id="featured-post-2" class="post hentry post-demo">
			<figure class="featured-content-image">
				<a title="' . esc_html__( 'Home Office', 'fabulous-fluid' ) .'" href="#">
					<img alt="' . esc_html__( 'Home Office', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-2.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="featured-post-3" class="post hentry post-demo">
			<figure class="featured-content-image">
				<a title="' . esc_html__( 'Vespa Scooter', 'fabulous-fluid' ) .'" href="#">
					<img alt="' . esc_html__( 'Vespa Scooter', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-3.jpg" />
				</a>`
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="featured-post-4" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' . esc_html__( 'Antique Clock', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-4.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h2 class="entry-title">
	...
	if( 'layout-five' == $layout || 'layout-six' == $layout ) {
		...
		<article id="featured-post-5" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' . esc_html__( 'Vintage Bicycle', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-5.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h2 class="entry-title">
	...
	if( 'layout-six' == $layout ) {
		...
		<article id="featured-post-6" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' . esc_html__( 'Fishing Boats', 'fabulous-fluid' ) .'" class="wp-post-image" src="'.trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'images/featured-6.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h2 class="entry-title">
	...
	if ( !empty( $page_list ) && $number_of_page > 0 ) {
		...
		while ( $loop->have_posts()) : $loop->the_post(); $i++;
			...
			$output .= '
				...
				$image = '<img class="no-featured-image" src="'.esc_url( get_template_directory_uri() ).'/images/no-featured-image-420x283.jpg" >';
