 ...
 */
function fabulous_fluid_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since  Fabulous Fluid 1.1
 */
function fabulous_fluid_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function fabulous_fluid_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function fabulous_fluid_sanitize_page( $input ) {
 ...
 * @since Fabulous Fluid 1.1
 */
function fabulous_fluid_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function fabulous_fluid_sanitize_number_range( $number, $setting ) {
 ...
 */
function fabulous_fluid_sanitize_select( $input, $setting ) {
 ...
 */
function fabulous_fluid_sanitize_important_link() {
	return false;
}