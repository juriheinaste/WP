	...
	<div class="row odd">
		<div class="col col-large">
			<div class="post">
				...
				<div class="img-holder">
					<img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img1.jpg" alt="">
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-large -->
			...
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail">
						<img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img2.jpg" alt="">
					</a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img3.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
	</div><!-- .row -->
	...
	<div class="row even" style="display: none;">
		<div class="col col-large">
			<div class="post">
				...
				<div class="img-holder">
					<img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img4.jpg" alt="">
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-large -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img5.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img6.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
	</div><!-- .row -->
	...
	<div class="row odd" style="display: none;">
		<div class="col col-large">
			<div class="post">
				...
				<div class="img-holder">
					<img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img7.jpg" alt="">
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-large -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img8.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img9.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
	</div><!-- .row -->
	...
	<div class="row even" style="display: none;">
		<div class="col col-large">
			<div class="post">
				...
				<div class="img-holder">
					<img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img10.jpg" alt="">
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-large -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img11.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
		...
		<div class="col col-small">
			<div class="post">
				...
				<div class="img-holder">
					<a href="#" class="post-thumbnail"><img src="' . trailingslashit( esc_url ( get_template_directory_uri() ) ) . '' . 'images/grid-img12.jpg" alt=""></a>
				</div><!-- .img-holder -->
			</div><!-- .post -->
		</div><!-- .col-small -->
	</div><!-- .row -->
				...
				$output .= '
					...
					<div class="img-holder">
						...
						if ( has_post_thumbnail() ) {
							...
							//Default no image
							$image = '<img class="no-image" src="'.esc_url( get_template_directory_uri() ).'/images/no-featured-image-420x283.jpg" >';

							if ( 'fabulous-fluid-grid-large' == $image_size ) {
								$image = '<img class="no-image" src="'.esc_url( get_template_directory_uri() ).'/images/no-featured-image-840x565.jpg" >';
							}
